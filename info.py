...
API_ID = int(environ.get('API_ID', '20899529'))
API_HASH = environ.get('API_HASH', '0297693c81aac01b704702f334decddd')

# Bot Token, This Is Main Bot
BOT_TOKEN = environ.get('BOT_TOKEN', "")

# Admin Telegram Account Id For Withdraw Notification Or Anything Else
ADMIN = int(environ.get('ADMIN', '8002803133'))
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002813558535'))
...
LINK_URL = environ.get("LINK_URL", "https://shivamanimes.blogspot.com/p/s.html")
